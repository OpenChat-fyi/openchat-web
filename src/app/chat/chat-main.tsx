...
export type ChainList = "11155111" | "420" | "421613" | "59144" | "534352" | "8453" | "168587773";
export const CHAIN_CONFIG = {
	...
	"168587773": {
		contract: "0x8456b1b38DCefce2838CEed5f7C6052731C64851",
...
const fetchMessages = async ({ pageParam }: { pageParam: number }) => {
	...
	return {
		...
		nextCursor: response.data.length ? (response.data.length === 50 ? pageParam + 1 : undefined) : undefined,
	};
};
		...
		<main className="flex flex-col min-h-screen items-center justify-between px-4 md:px-72 py-8 pt-11 max-h-screen">
			...
			<div className="w-full pt-2">
				<div className="grid w-full gap-2">
					...
					{input.length > 256 ? <p className="text-sm text-destructive">Message must be under 256 characters</p> : null}
